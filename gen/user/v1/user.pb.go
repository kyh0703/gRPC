...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x22, 0x6f, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x65, 0x73,
	...
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.v1.GetUserResponse.user_message:type_name -> user.v1.UserMessage
	0, // 1: user.v1.ListUsersResponse.user_messages:type_name -> user.v1.UserMessage
	1, // 2: user.v1.User.GetUser:input_type -> user.v1.GetUserRequest
	3, // 3: user.v1.User.ListUsers:input_type -> user.v1.ListUsersRequest
	2, // 4: user.v1.User.GetUser:output_type -> user.v1.GetUserResponse
	4, // 5: user.v1.User.ListUsers:output_type -> user.v1.ListUsersResponse
...
func (c *userClient) ListUsers(ctx context.Context, in *ListUsersRequest, opts ...grpc.CallOption) (*ListUsersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user.v1.User/ListUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_ListUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.User/ListUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
